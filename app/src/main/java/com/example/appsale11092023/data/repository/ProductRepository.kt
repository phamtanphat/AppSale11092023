...
object ProductRepository {
    ...
    fun getProductList(onListenResponse: AppInterface.OnListenResponse<List<ProductDTO>>) {
        CoroutineScope(Dispatchers.IO).launch {
            apiService.getProductList().enqueue(object : Callback<AppResponseDTO<List<ProductDTO>>> {
                override fun onFailure(call: Call<AppResponseDTO<List<ProductDTO>>>, t: Throwable) {
                ...
                override fun onResponse(
                    ...
                    } else if (response.body() != null && StatusCodeType.hasCodeError(response.code())){
